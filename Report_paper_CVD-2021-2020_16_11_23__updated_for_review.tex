...
\urlstyle{same}
\hypersetup{
  pdftitle={Impact of Gamma COVID-19 variant on the prognosis of hospitalized pregnant and postpartum women with cardiovascular disease},
  hidelinks,
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{NU\_IDADE\_N)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ctable}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{CVD\_by\_year, data}\SpecialCharTok{$}\NormalTok{hepatic, }\AttributeTok{chisq=}\ConstantTok{FALSE}\NormalTok{, }\AttributeTok{prop=}\StringTok{"r"}\NormalTok{, }\AttributeTok{OR=}\ConstantTok{FALSE}\NormalTok{, }\AttributeTok{useNA =} \StringTok{"no"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data}\SpecialCharTok{$}\NormalTok{cardio }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{CVD\_by\_year}\SpecialCharTok{==}\StringTok{"2021"}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{)}

\FunctionTok{bal.tab}\NormalTok{(cardio }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ethnicity }\SpecialCharTok{+}\NormalTok{ classi\_gesta\_puerp }\SpecialCharTok{+}\NormalTok{ obesity }\SpecialCharTok{+}\NormalTok{ diabetes }\SpecialCharTok{+}\NormalTok{ NU\_IDADE\_N, }\AttributeTok{data =}\NormalTok{ data, }\AttributeTok{estimand =} \StringTok{"ATE"}\NormalTok{, }\AttributeTok{m.threshold =}\NormalTok{ .}\DecValTok{05}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# Estimating the weights of each sampling unit}
\NormalTok{fit }\OtherTok{\textless{}{-}} \FunctionTok{weightit}\NormalTok{(cardio }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ethnicity }\SpecialCharTok{+}\NormalTok{ classi\_gesta\_puerp }\SpecialCharTok{+}\NormalTok{ obesity  }\SpecialCharTok{+}\NormalTok{ diabetes }\SpecialCharTok{+}\NormalTok{ NU\_IDADE\_N, }\AttributeTok{use.mlogit =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{data =}\NormalTok{ data,}
                  \AttributeTok{method =} \StringTok{"ps"}\NormalTok{, }\AttributeTok{estimand =} \StringTok{"ATE"}\NormalTok{)}

\NormalTok{data}\SpecialCharTok{$}\NormalTok{weight }\OtherTok{\textless{}{-}}\NormalTok{ fit}\SpecialCharTok{$}\NormalTok{weights}

\FunctionTok{bal.tab}\NormalTok{(fit, }\AttributeTok{m.threshold =} \FloatTok{0.05}\NormalTok{, }\AttributeTok{disp.v.ratio =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{d\_yes }\OtherTok{\textless{}{-}}\NormalTok{ data }\SpecialCharTok{\%\textgreater{}\%} 
   \FunctionTok{filter}\NormalTok{(CVD\_by\_year }\SpecialCharTok{==} \StringTok{"2021"} \SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(icu\_days))}
\NormalTok{d\_no }\OtherTok{\textless{}{-}}\NormalTok{ data }\SpecialCharTok{\%\textgreater{}\%} 
   \FunctionTok{filter}\NormalTok{(CVD\_by\_year }\SpecialCharTok{==} \StringTok{"2020"} \SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(icu\_days))}

\FunctionTok{wtd.t.test}\NormalTok{(d\_yes}\SpecialCharTok{$}\NormalTok{icu\_days, d\_no}\SpecialCharTok{$}\NormalTok{icu\_days, }\AttributeTok{weight =}\NormalTok{ d\_yes}\SpecialCharTok{$}\NormalTok{weight, }\AttributeTok{weighty =}\NormalTok{ d\_no}\SpecialCharTok{$}\NormalTok{weight)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{d\_yes }\OtherTok{\textless{}{-}}\NormalTok{ data }\SpecialCharTok{\%\textgreater{}\%} 
   \FunctionTok{filter}\NormalTok{(CVD\_by\_year }\SpecialCharTok{==} \StringTok{"2021"} \SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(days\_symp\_evol))}
\NormalTok{d\_no }\OtherTok{\textless{}{-}}\NormalTok{ data }\SpecialCharTok{\%\textgreater{}\%} 
   \FunctionTok{filter}\NormalTok{(CVD\_by\_year }\SpecialCharTok{==} \StringTok{"2020"} \SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(days\_symp\_evol))}

\CommentTok{\# Performing weighted Student\textquotesingle{}s t{-}tests to compare the CVD\_by\_year and non{-}CVD\_by\_year groups with respect to the time elapsed between the start of symptoms and the outcome.}
\FunctionTok{wtd.t.test}\NormalTok{(d\_yes}\SpecialCharTok{$}\NormalTok{days\_symp\_evol, d\_no}\SpecialCharTok{$}\NormalTok{days\_symp\_evol, }\AttributeTok{weight =}\NormalTok{ d\_yes}\SpecialCharTok{$}\NormalTok{weight, }\AttributeTok{weighty =}\NormalTok{ d\_no}\SpecialCharTok{$}\NormalTok{weight)}
\end{Highlighting}
\end{Shaded}
...
## $coefficients
##      t.value           df      p.value 
## 3.296454e+00 5.936898e+02 1.037562e-03 
## 
## $additional
## Difference     Mean.x     Mean.y   Std. Err 
##   3.534656  20.343870  16.809215   1.072260
\end{verbatim}

\hypertarget{considering-only-death-cases}{%
\subsubsection{Considering only death
cases}\label{considering-only-death-cases}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{d\_yes }\OtherTok{\textless{}{-}}\NormalTok{ df }\SpecialCharTok{\%\textgreater{}\%} 
   \FunctionTok{filter}\NormalTok{(CVD\_by\_year }\SpecialCharTok{==} \StringTok{"2021"} \SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(days\_symp\_evol))}
\NormalTok{d\_no }\OtherTok{\textless{}{-}}\NormalTok{ df }\SpecialCharTok{\%\textgreater{}\%} 
   \FunctionTok{filter}\NormalTok{(CVD\_by\_year }\SpecialCharTok{==} \StringTok{"2020"} \SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(days\_symp\_evol))}

\CommentTok{\# Fixed the death cases, we perform a weighted Student\textquotesingle{}s t{-}tests to compare the CVD and non{-}CVD groups with respect to the time elipsed between the start of symptoms and the outcome.}
\FunctionTok{wtd.t.test}\NormalTok{(d\_yes}\SpecialCharTok{$}\NormalTok{days\_symp\_evol, d\_no}\SpecialCharTok{$}\NormalTok{days\_symp\_evol, }\AttributeTok{weight =}\NormalTok{ d\_yes}\SpecialCharTok{$}\NormalTok{weight, }\AttributeTok{weighty =}\NormalTok{ d\_no}\SpecialCharTok{$}\NormalTok{weight)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Fixed the cure cases, we perform a weighted Student\textquotesingle{}s t{-}tests to compare the CVD and non{-}CVD groups with respect to the time elipsed between the start of symptoms and the outcome.}
\FunctionTok{wtd.t.test}\NormalTok{(d\_yes}\SpecialCharTok{$}\NormalTok{days\_symp\_evol, d\_no}\SpecialCharTok{$}\NormalTok{days\_symp\_evol, }\AttributeTok{weight =}\NormalTok{ d\_yes}\SpecialCharTok{$}\NormalTok{weight, }\AttributeTok{weighty =}\NormalTok{ d\_no}\SpecialCharTok{$}\NormalTok{weight)}
\end{Highlighting}
\end{Shaded}
